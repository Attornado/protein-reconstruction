...
PRE_TRAINED_MODEL_PATH: final = os.path.join(DATA_PATH, "fitted", "pretraining", "vgae", "vgae_rev_test18")
...
def main(args):
    ...
    if pretrained_model_type == "vgae":
        ...
        if m == "sage_c":
            ...
            emb = vgae.encoder._encoder_mu.config["dim_embedding"]*vgae.encoder.encoder_mu.config["num_layers"]
